...
args: [],
source: "begin\x0a\x22Makes me say hello to the user.\x22\x0a\x0a| msg button |\x0aconsole log:'BEGIN'.\x0amsg := 'Hello world!'.\x0abutton := '#sayHello' asJQuery.\x0abutton click: [console log:'Click!'.button after: '<p>' , msg , '</p>'].",
messageSends: ["log:", "asJQuery", "click:", "after:", ","],
referencedClasses: []
}),
smalltalk.Hello);
